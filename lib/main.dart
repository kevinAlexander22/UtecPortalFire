...
Widget cuerpo(BuildContext context) {
  ...
  return Container(
      ...
      child: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                width: double.infinity, // Ajusta el ancho de la imagen al ancho de la pantalla
                height: MediaQuery.of(context).size.height * 0.5, // Altura de la imagen
                child: Image.asset(
                  "assets/logo_utec.png",
                  fit: BoxFit.contain, // Ajusta la imagen sin distorsionarla
                ),
              ),
              SizedBox(height: 5), // Espacio entre la imagen y otros elementos
              Align(
              ...
              Align(
                alignment: Alignment.center,
                child: Screen1(userController: userController,
                  passwordController: passwordController,),
              ),
              SizedBox(height: 20),
              Align(
   ...
   Widget name(){
      return Text("Sing in",style: TextStyle(color: const Color.fromARGB(255, 0, 0, 0),fontSize: 19,fontWeight: FontWeight.bold),);
   }
...
//  TextEditingController passwordController = TextEditingController();
 ...
 // Obtener los valores ingresados por el usuario
       // Obtener los valores ingresados por el usuario
          ...
          DocumentSnapshot userSnapshot = await _firestore.collection('usuarios').doc('idUsuario').get(); //userEntered
          ...
          if (userSnapshot.exists) {
            ...
            if (_validateUser(userEntered, storedUser) && _validatePassword(passwordEntered, storedPassword)) {
 ...
 class invitado extends StatelessWidget {
  ...
  style: ElevatedButton.styleFrom( 
     shape: RoundedRectangleBorder(
      ...
      padding: EdgeInsets.symmetric(horizontal: 30, vertical: 10)),//modificar tamaño del boton 
      child: Text("Invitado"),
      onPressed: ()=> {
         Navigator.push(
          context, 
